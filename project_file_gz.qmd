...
```{r}
#Creating a function called scrape_events to scrape info
#   using the CSS path and compile it into a tibble 
...
#   we used str_to_title to have them all in title case
